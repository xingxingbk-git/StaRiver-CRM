...
VALUES
('pm1', 'p1', NULL, '数据接入', 'admin', '孙毅', 3, 1, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm1-1', 'p1', 'pm1', '设备采集', 'admin', '刘凯', 1, 1, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm1-2', 'p1', 'pm1', '文件导入', 'admin', '李文', 1, 2, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm1-3', 'p1', 'pm1', '接口同步', 'admin', '高明', 1, 3, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm2', 'p1', NULL, '模型训练', 'admin', '周志远', 5, 2, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm2-1', 'p1', 'pm2', '训练任务', 'admin', '陈立文', 3, 1, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin'),
('pm2-2', 'p1', 'pm2', '评估中心', 'admin', '孙媛', 2, 2, '100001', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin');
...
('pr1', 'PRM-2026-0106-01', 'BI 看板支持多维钻取与自定义指标', '功能新增', '客户', 'p1', 'StaRiver', 'v4.0', 'pm2', '模型训练',
 'P1', '需求评估', '需求评审', '2026-Q3', 'admin', '陈立文',
...
('pr2', 'PRM-2026-0148-01', '告警引擎支持 Flink 实时处理', '性能改进', '内部', 'p1', 'StaRiver', 'v4.0', 'pm1', '数据接入',
 'P0', '开发中', '开发', '2026-Q3', 'admin', '陈立文', '实时告警链路支持 Flink 处理。', '延迟低于 5 秒。',
 '100001', UNIX_TIMESTAMP() * 1000 + 1, UNIX_TIMESTAMP() * 1000 + 1, 'admin', 'admin'),
('pr3', 'PRM-2026-0110-01', 'FinGuard 合规报告自动生成（GB/T 40660）', '功能新增', '内部', 'p2', 'OptiQA', 'v2.2', NULL, NULL,
 'P0', '待发布', '产品验收', '2026-Q4', 'admin', '李薇', '合规报告自动生成。', '完成报告导出和格式校验。',
 '100001', UNIX_TIMESTAMP() * 1000 + 2, UNIX_TIMESTAMP() * 1000 + 2, 'admin', 'admin');
